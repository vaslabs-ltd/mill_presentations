...
\begin{frame}[fragile]{Jetpack Compose Compiler Plugin}
  ...
  \end{itemize}
  \begin{block}{Dependency resolution Motivation}
...
\begin{frame}[fragile]{Hilt / Dagger Annotation Processing}
  \begin{itemize}
    ...
    \item Support for Kotlin Symbol Processing (KSP) - which also extended Mill support for other platforms and frameworks
...
\begin{block}{References}
  Bytecode is of TodoActivity in architecture-samples.
...
\begin{frame}{Ongoing Work}
  \begin{itemize}
    \item Improve IDE integration (intelliJ) Support for:
      ...
      \end{itemize}
    \item Support well known third party plugins and frameworks (e.g. Roboelectric)
  \end{itemize}
\end{frame}

\begin{frame}{What's working well}
  \begin{itemize}
    \item Building from the CLI
    \item Increased isolation compared to Gradle
...
\begin{frame}{How to get started}
  \begin{itemize}
    ...
    \item Android setup: https://mill-build.org/mill/android/android-initial-setup.html
